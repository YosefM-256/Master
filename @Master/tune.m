function [msg,points] = tune(master, tune, by, target, relation, alpha, decayCoefficient, maxDAC)
    ...
    function updatePlots()
        ...
        plot(master.DACAxis,[pointsMat.(by)],'color','blue','Marker','o', ...
            'MarkerSize',4,'MarkerFaceColor','auto');
        plot(master.errorAxis,abs([pointsMat.(tune)]-target),'color','r', ...
            'Marker','o','MarkerSize',4,'MarkerFaceColor','auto');
        plot(master.parameterAxis,[pointsMat.(tune)], ...
            'Marker','o','MarkerSize',4,'MarkerFaceColor','auto');
        plot(master.DACparameterMapAxis,[pointsMat.(by)],[pointsMat.(tune)],'color','r', ...
            'Marker','o','MarkerSize',4,'MarkerFaceColor','auto');
    end
